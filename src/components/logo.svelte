...
{#if intro}
  <style>
      .logo-l1 {
          ...
          animation: logo-dash .3s cubic-bezier(0, .5, .5, 1) forwards;
          animation-delay: .3s;
          opacity: 0;
      }
      ...
      .logo-l2 {
          ...
          animation: logo-dash .1s linear forwards;
          animation-delay: .4s;
          opacity: 0;
      }
      ...
      .logo-l3 {
          ...
          animation: logo-dash .3s cubic-bezier(0, .2, .2, 1) forwards;
          animation-delay: .52s;
          opacity: 0;
      }
...
<svg height="535" class="splashSvg" overflow="hidden" viewBox="0 0 597 535" width="597" style="--size:{size}">
  <defs>
    <clipPath id={'c'+id}>
